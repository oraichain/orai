...
// InitCmd returns a command that initializes all files needed for Tendermint and Oraichain app.
// this overrides the default InitCmd from the genutil to apply customAppState
