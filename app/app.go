...
import (
	...
	transfer "github.com/oraichain/orai/x/ibc/applications/transfer"
	ibctransferkeeper "github.com/oraichain/orai/x/ibc/applications/transfer/keeper"
	ibctransfertypes "github.com/oraichain/orai/x/ibc/applications/transfer/types"
	ibc "github.com/oraichain/orai/x/ibc/core"
	ibcclient "github.com/oraichain/orai/x/ibc/core/02-client"
	porttypes "github.com/oraichain/orai/x/ibc/core/05-port/types"
	ibchost "github.com/oraichain/orai/x/ibc/core/24-host"
	ibckeeper "github.com/oraichain/orai/x/ibc/core/keeper"
...
func (app *OraichainApp) upgradeHandler() {
	app.upgradeKeeper.SetUpgradeHandler("v0.40.3", func(ctx sdk.Context, plan upgradetypes.Plan) {
