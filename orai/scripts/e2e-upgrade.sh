...
UPGRADE_HEIGHT=30
oraid tx gov submit-proposal software-upgrade $NEW_VERSION --title "foobar" --description "foobar"  --from validator1 --upgrade-height 30 --upgrade-info "x" --deposit 10000000orai --home $VALIDATOR_HOME --chain-id testing -y --keyring-backend test --fees 200orai --gas auto --gas-adjustment 1.5 -b block
oraid tx gov vote 1 yes --from validator1 --home "$HOME/.oraid/validator1" --chain-id testing -y --keyring-backend test --fees 200orai --gas auto --gas-adjustment 1.5 -b block && oraid tx gov vote 1 yes --from validator2 --home "$HOME/.oraid/validator2" --chain-id testing -y --keyring-backend test --fees 200orai --gas auto --gas-adjustment 1.5 -b block
