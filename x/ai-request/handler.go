...
import (
	...
	providerType "github.com/oraichain/orai/x/ai-request/types"
...
func handleMsgSetPriceRequest(ctx sdk.Context, k keeper.Keeper, msg types.MsgSetPriceRequest) (*sdk.Result, error) {
	...
	rewardRatio := sdk.NewDecWithPrec(int64(k.GetParam(ctx, providerType.KeyOracleScriptRewardPercentage)), 2)
