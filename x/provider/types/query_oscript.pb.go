...
type OracleScriptInfoRes struct {
	...
	DSources    []string                                      `protobuf:"bytes,6,rep,name=d_sources,json=dSources,proto3" json:"data_sources,omitempty"`
	TCases      []string                                      `protobuf:"bytes,7,rep,name=t_cases,json=tCases,proto3" json:"test_cases,omitempty"`
}
...
type MinFeesReq struct {
	OracleScriptName string `protobuf:"bytes,1,opt,name=OracleScriptName,proto3" json:"oscript_name,omitempty"`
	ValNum           int64  `protobuf:"varint,2,opt,name=ValNum,proto3" json:"val_num,omitempty"`
}
...
type MinFeesRes struct {
	MinFees string `protobuf:"bytes,1,opt,name=minFees,proto3" json:"minimum_fees,omitempty"`
}
...
var fileDescriptor_e4abb115fe145c3e = []byte{
	...
	,
}
