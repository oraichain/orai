...
var (
	...
	ErrNeedMoreFees           = sdkerrors.Register(ModuleName, 13, "Total fee is higher than the fee given")
	ErrPaginationInputInvalid = sdkerrors.Register(ModuleName, 14, "The page and limit inputs are invalid")
	ErrCannotGetMinimumFees   = sdkerrors.Register(ModuleName, 15, "Cannot retrieve minimum fees")
)
