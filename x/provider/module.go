...
// ValidateGenesis performs genesis state validation for the provider module.
...
// RegisterRESTRoutes registers the REST routes for the provider module.
func (AppModuleBasic) RegisterRESTRoutes(ctx context.CLIContext, rtr *mux.Router) {
	rest.RegisterRoutes(ctx, rtr)
}

// GetTxCmd returns the root tx command for the provider module.
func (AppModuleBasic) GetTxCmd(cdc *codec.Codec) *cobra.Command {
	return cli.GetTxCmd(cdc)
}

// GetQueryCmd returns no root query command for the provider module.
...
// RegisterInvariants registers the provider module invariants.
...
// NewQuerierHandler returns the provider module sdk.Querier.
...
// BeginBlock returns the begin blocker for the provider module.
