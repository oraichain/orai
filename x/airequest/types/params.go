...
var (
	...
	KeyMaximumAIRequestReqBytes   = []byte("MaximumRequestBytes")
	KeyMaximumAIRequestResBytes   = []byte("RewardPercentageBytes")
	KeyAIRequestRewardPercentages = []byte("KeyAIRequestRewardPercentages")
...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	return paramtypes.ParamSetPairs{
		...
		paramtypes.NewParamSetPair(KeyMaximumAIRequestReqBytes, &p.MaximumAiOracleRequestBytes, validateMaximumAiOracleReqBytes),
		paramtypes.NewParamSetPair(KeyMaximumAIRequestResBytes, &p.MaximumAiOracleResponseBytes, validateMaximumAiOracleResBytes),
		paramtypes.NewParamSetPair(KeyAIRequestRewardPercentages, &p.RewardAiOraclePercentages, validateAIRequestRewardPercentages),
...
func validateAIRequestRewardPercentages(i interface{}) error {
	v, ok := i.(int)
	if !ok {
		return fmt.Errorf("invalid parameter type: %T", i)
	}
