...
route() {
  if [[ $1 = "aiDataSource" ]]
  then 
    echo "image_classification image_classification image_classification" # return names of the data sources
  elif [[ $1 = "testcase" ]] # return names of the test cases
  then
    echo "testcase_classification testcase_classification"
