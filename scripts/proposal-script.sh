...
oraid tx gov submit-proposal software-upgrade "v0.41.3" --title "foobar" --description "foobar"  --from validator1 --upgrade-height $HEIGHT --upgrade-info "x" --deposit 10000000orai --chain-id testing --keyring-backend test --home $VALIDATOR_HOME -y --fees 2orai -b block
