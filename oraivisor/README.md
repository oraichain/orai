...
oraid tx gov submit-proposal software-upgrade "v0.41.0" --title "upgrade Oraichain network to v0.41.0 that patches the Dragonberry advisory with custom CosmWasm that supports backward compatibility for v0.13.2" --description "Please visit https://github.com/oraichain/orai to view the CHANGELOG for this upgrade" --from $USER --upgrade-height 9415363 --upgrade-info "https://orai.s3.us-east-2.amazonaws.com/v0.41.0_new/manifest.json" --deposit 10000000orai --chain-id Oraichain-testnet -y
